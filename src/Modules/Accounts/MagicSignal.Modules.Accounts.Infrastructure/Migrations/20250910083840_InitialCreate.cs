        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VipRequestId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VipMembershipRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VipMembershipRequests_Users_ProcessedBy",
                        column: x => x.ProcessedBy,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_VipMembershipRequests_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VipRequests_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdminApprovals_VipRequestId",
                table: "AdminApprovals",
                column: "VipRequestId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VipMembershipRequests_ProcessedBy",
                table: "VipMembershipRequests",
                column: "ProcessedBy");

            migrationBuilder.CreateIndex(
                name: "IX_VipMembershipRequests_UserId",
                table: "VipMembershipRequests",
                column: "UserId");
